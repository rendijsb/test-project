...
class GetAllUsersRequest extends FormRequest
{
    ...
    private const DEFAULT_SORT_BY = User::NAME;
    ...
    {
        return $this->user()->can(UserPolicy::VIEW_ANY, User::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            self::SEARCH => [ValidationHelper::SOMETIMES, ValidationHelper::STRING, ValidationHelper::max(255)],
        ];
    }
    ...
    {
        return $this->validated(self::SEARCH);
    }

    public function responseResource(LengthAwarePaginator $paginator): UserResourceCollection
    {
        return new UserResourceCollection($paginator);
    }
}
